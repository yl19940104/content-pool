		...
		<div class="layout">
				...
				<ul class="nav nav-tabs left">
				   ...
				   <li class="dropdown open leftnav">
				      ...
				      <ul class="dropdown-menu">
				         ...
				         <li class="divider"></li>
				         <li><a class="active" href="<?php echo U('index/features');?>">Features</a></li>
				         <li class="divider"></li>
			...
			<div class="content">
			    <?php if(is_array($select)): $i = 0; $__LIST__ = $select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div>
								...
								<label>
								<?php $__FOR_START_15164__=0;$__FOR_END_15164__=$vo['difficulty'];for($i=$__FOR_START_15164__;$i < $__FOR_END_15164__;$i+=1){ ?><span class="glyphicon glyphicon-star star"></span><?php } ?>	
								</label>
								<p>
									<?php echo ($vo['content']); ?>
								</p>
