...
<div class="searchdiv">
	...
	<li class="dropdown open leftnav">
		...
		<ul class="dropdown-menu">
			<li>
				<a href="<?php echo U('User/user_center');?>">My Profile</a>
			</li>
			<?php if(($group == 2 or $group == 3)): ?><li>
					<a href="<?php echo U('index/article_edit');?>?edit_id=1">Add New Articles</a>
				</li>
				<li>
					<a href="<?php echo U('User/uploaded_articles');?>">Uploaded Articles</a>
				</li><?php endif; ?>
			<?php if(($group == 2)): ?><li>
					<a href="<?php echo U('User/download_articles');?>">Download Articles</a>
				</li><?php endif; ?>
			<?php if(($group != 4)): ?><li>
					<a href="<?php echo U('User/recyclebin');?>">Recycle Bin</a>
				</li><?php endif; ?>
			<?php if(($group == 1)): ?><li>
					<a href="<?php echo U('User/management');?>">User Management</a>
				</li>
				<li>
					<a href="<?php echo U('User/article_tag');?>">Article Tags</a>
				</li><?php endif; ?>
		</ul>
	</li>
	<li class="divider"></li>
	        ...
	        $.post("<?php echo U('User/avator');?>",function(a){
				swal({
						...
						showConfirmButton: false
					 	...
					 	location.href="<?php echo U('User/user_center');?>";
					 }
					); 		
			});
		}
