		...
		<div class="layout">
				...
				<ul class="nav nav-tabs left">
				   ...
				   <li class="dropdown open leftnav">
				      ...
				      <ul class="dropdown-menu">
				         ...
				         <li class="divider"></li>
				         <li><a href="<?php echo U('index/eat');?>">Eat&Drink</a></li>
				         <li class="divider"></li>
				         <li><a href="<?php echo U('index/art');?>">Art&Entertainment</a></li>
				         <li class="divider"></li>
				         <li><a href="<?php echo U('index/life');?>">Lifestyle</a></li>
				         <li class="divider"></li>
				         <li><a class="active" href="<?php echo U('index/education');?>">Education</a></li>
				         <li class="divider"></li>
			...
			<div class="content">
			    <?php if(is_array($select)): $i = 0; $__LIST__ = $select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div>
								...
								<label>
								<?php $__FOR_START_15219__=0;$__FOR_END_15219__=$vo['difficulty'];for($i=$__FOR_START_15219__;$i < $__FOR_END_15219__;$i+=1){ ?><span class="glyphicon glyphicon-star star"></span><?php } ?>	
								</label>
								<p>
									<?php echo ($vo['content']); ?>
								</p>
